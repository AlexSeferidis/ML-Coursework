...
class SigmoidLayer(Layer):
    ...
    def backward(self, grad_z):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        grad_sigma = self._cache_current * (1-self._cache_current)
        return grad_z * grad_sigma
...
class ReluLayer(Layer):
    ...
    def backward(self, grad_z):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        grad_relu = np.zeros_like(self._cache_current)
        grad_relu[self._cache_current > 0] = grad_z[self._cache_current > 0]
...
class Trainer(object):
    ...
    def shuffle(input_dataset, target_dataset):
        ...
        order = np.random.permutation(len(input_dataset))
    ...
    def train(self, input_dataset, target_dataset):
        ...
        for epoch in range(self.nb_epoch):
            ...
            for i in range(0, len(input_dataset), self.batch_size):
                ...
                loss = self._loss_layer.forward(y_pred, y_batch)
